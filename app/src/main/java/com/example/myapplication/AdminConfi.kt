...
import com.example.myapplication.databinding.FragmentConfiAdminBinding

class AdminConfi : Fragment() {

    private var _binding: FragmentConfiAdminBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentConfiAdminBinding.inflate(inflater, container, false)
        return binding.root
    }
